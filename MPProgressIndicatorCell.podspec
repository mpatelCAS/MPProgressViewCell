#
#  Be sure to run `pod spec lint MPProgressIndicatorCell.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mayank Patel"
  # s.authors            = { "mpatel" => "mpatel@customapps.in" }
  # s.social_media_url   = "https://www.facebook.com/patelmayankp"
  ...
  s.source       = { :git => "https://github.com/mpatelCAS/MPProgressViewCell.git", :tag => "0.0.1" }
  ...
  s.source_files  = "MPProgressViewCell", "MPProgressViewCell/**/*.{h,m}"
  s.exclude_files = "MPProgressViewCell/Exclude"
